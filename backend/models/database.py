...
async def seed_data():
    ...
    async with aiosqlite.connect(DB_PATH_STR) as db:
        ...
        # 导入门店数据
        stores = [
            ("万象城零售管理授权旗舰店", "贵州", "935222159", 1),
            ("华润万象汇零售管理授权体验店", "贵州", "574246116", 2),
            ("兴义梦乐城零售管理授权体验店", "贵州·兴义", "639950218", 3),
            ("遵义吾悦零售管理授权体验店", "贵州·遵义", "430232289", 4),
            ("曲靖万达零售管理授权体验店", "云南·曲靖", "983685022", 5),
            ("六盘水零售管理授权体验店", "贵州·六盘水", "975306497", 6),
            ("龙湾万达零售管理授权体验店", "贵州·贵阳", "492986089", 7),
            ("昭通吾悦零售管理授权体验店", "云南·昭通", "899271796", 8),
            ("清镇吾悦零售管理授权体验店", "贵州·清镇", "894469704", 9),
            ("安顺零售管理授权体验店", "贵州·安顺", "979460265", 10),
            ("蒙自零售管理授权体验店", "云南·蒙自", "", 11),  # 第11家门店，补充进种子数据
        ]
...
async def _seed_default_activities():
    ...
    async with aiosqlite.connect(DB_PATH_STR) as db:
        ...
        activities = [
            ...
            ("以旧换新补贴", "任意品牌旧手机换购新机，最高补贴1000元", "2026-06-01", "2026-12-31"),
        ]
